...
class InstancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post instances_url, params: { instance: { id_instance: @instance.id_instance, month: @instance.month, year: @instance.year } }
    end
  ...
  test "should update instance" do
    patch instance_url(@instance), params: { instance: { id_instance: @instance.id_instance, month: @instance.month, year: @instance.year } }
